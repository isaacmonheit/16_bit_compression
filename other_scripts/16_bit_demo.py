...
# img = cv2.imread('tests/decode_video_test7/reconstructed_images/reconstructed_frame_150.png', cv2.IMREAD_UNCHANGED)
# img = cv2.imread('tests/superframe_tests/superframe.png', cv2.IMREAD_UNCHANGED)
img = cv2.imread('tests/superframe_tests/split_frames/frame_200.png', cv2.IMREAD_UNCHANGED)
